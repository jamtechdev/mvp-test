  ...
  return (
    <div
      ...
      style={{
        ...
        maxWidth: isExpanded ? "960px" : "440px",
        height: isExpanded ? "80vh" : "440px",
        borderRadius: "1rem",
        display: "flex",
        flexDirection: "column",
        zIndex: 1050,
        ...
        border: theme.scheme === "dark" ? "" : "1px solid rgb(55, 190, 176)",
        transition:
          "transform 0.25s ease, opacity 0.25s ease, width 0.3s ease, height 0.3s ease",
        transform: "translateY(0)",
        opacity: 1,
      }}
    >
      ...
      <div
        ref={bodyRef}
        className="flex-grow-1 overflow-auto p-3"
        style={{ background: theme.bodyBg, maxHeight: "100%" }}
      >
        {messages.map((m, i) => (
          <div
            key={i}
